...
export const colorado: State = {
  ...
  resources: [
    { label: "State Hemp Program", url: "https://ag.colorado.gov/plants/hemp" },
    { label: "License/Application Portal", url: "" },
    { label: "Testing Requirements", url: "https://ag.colorado.gov/plants/hemp" }
  ],
  regulatoryBody: "Colorado Department of Agriculture",
  regulatoryUrl: "https://ag.colorado.gov/plants/hemp",
