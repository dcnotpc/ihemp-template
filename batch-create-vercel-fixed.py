...
Fixed version after rootDirectory error.
"""
...
# Already created projects (as of April 8, 2026)
CREATED = [
    "alabama", "arkansas", "california", "colorado", "florida", 
    "georgia", "indiana", "iowa", "kansas"
]

# Remaining states to create
STATES = [
    "kentucky", "michigan", "mississippi", "nebraska", "ohio",
...
def main():
    print("=" * 60)
    print("🌿 iHemp Vercel Batch Creator - Fixed")
    print("=" * 60)
    ...
    print(f"\n✅ Successfully processed: {len(created)} states")
    ...
    print("\n🔗 All 17 iHemp states will be available at:")
    all_states = STATES + ["alabama", "colorado"]
    for state in sorted(all_states):
        domain = DOMAINS.get(state) or f"ihemp{state}.com"
